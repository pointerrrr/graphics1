...
namespace Template
{
	...
	class Exercise3 : Game
	{
		...
		public override void Tick()
		{
			...
			a = (float) ( Math.PI / 90 );
			screen.Line(TX(0), TY(-2), TX(0), TY(2), 0x0);
			screen.Line(TX(-2), TY(0), TX(2), TY(0), 0x0);
			/*screen.Print("-1", 2, 2, 0xffffff);
			screen.Print("-1", 2, 2, 0xffffff);
			screen.Print("0", 2, 2, 0xffffff);
			screen.Print("1", 2, 2, 0xffffff);
			screen.Print("1", 2, 2, 0xffffff);
			screen.Print("2", 2, 2, 0xffffff);
			screen.Print("2", 2, 2, 0xffffff);*/
